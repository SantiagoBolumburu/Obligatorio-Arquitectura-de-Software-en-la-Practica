...
namespace GESINV.SubscriptionsService.DataAccess.Migrations
{
    ...
    [Migration("20230618062259_Migracion004-ProductoMainId-is-unique-now")]
    partial class Migracion004ProductoMainIdisuniquenow
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("GESINV.SubscriptionsService.Dominio.CompraVentaSubscription", b =>
                {
                    ...
                    b.HasIndex("ProductoId", "UsuarioId")
                        .IsUnique();
